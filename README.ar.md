...
دالة هيئ()؛
دالة هيئ(اللغة: نـص)؛
دالة هيئ(اللغة: نـص، مسار_التوطين: نـص)؛
```
...
تُهيئ المكتبة وتحمل الترجمات المخصصة باللغة المعطاة. النسخة الأولى تستخدم لغة النظام الحالية تلقائيا. 
النسخة الثانية تسمح بتحديد لغة مخصصة. النسخة الثالثة تسمح بتحديد لغة مخصصة ومسار مخصص لملفات التوطين.
النسختان الأولى والثانية تضمنان الترجمات في البرنامج التنفيذي أثناء الترجمة، بينما تحمل النسخة الثالثة
