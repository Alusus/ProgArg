...
The first version assumes all arguments will be consumed and exits the program with an error if any unknown arguments remain, i.e if the return value isn't at the end of the `Process.args` array.
